...
evaluation_params = json.loads(
    """{"IOU_CONSTRAINT":0.5,"AREA_PRECISION_CONSTRAINT":0.5,"GT_SAMPLE_NAME_2_ID":"gt_img_([0-9]+).txt","DET_SAMPLE_NAME_2_ID":"res_img_([0-9]+).txt","LTRB":false,"CRLF":false,"CONFIDENCES":false}"""
)
# Upload instructions
instructions = """<ul>
